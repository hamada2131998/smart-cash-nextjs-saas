...
import { DollarSign, FileText, Clock, TrendingUp, TrendingDown, AlertCircle } from 'lucide-react';
        ...
        <div className="stat-card">
          <div className="flex items-center justify-between">
            ...
            {stats.expensesChange !== 0 && (
              <span className={`text-sm font-medium ${stats.expensesChange > 0 ? 'text-success-600' : 'text-danger-600'}`}>
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 card">
          ...
          <div className="card-body p-0">
            ...
            {recentExpenses.length === 0 && <div className="p-8 text-center text-gray-500">لا توجد مصروفات بعد</div>}
          </div>
        </div>
        ...
        <div className="card">
          ...
          <div className="card-body space-y-4">
                ...
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span
                    className={`text-sm font-medium ${
                      custody.utilization > 80
                        ? 'text-danger-600'
                        : custody.utilization > 60
                          ? 'text-warning-600'
                          : 'text-success-600'
                    }`}
                  >
            ...
            {topCustodies.length === 0 && <div className="p-8 text-center text-gray-500">لا توجد عهد بعد</div>}
          </div>
        </div>
      </div>
